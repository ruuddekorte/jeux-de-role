...
class Elfe {
	...
	private $name="";
	private $type="elfe";      // Elfe, Gobelin, Guerrier, MageNoir, Magicien, Nain, OmbreNoir, Orque, Sauron
	private $side="hero" ;     // côté :heros ou monstres
	private $forceMin=0 ;     // attaque-Minimum
	private $forceMax=300 ;     // attaque-maximum
	private $health=500;          // points de vie
	private $specialty="orque" // Spécialité : Elfe, Gobelin, Guerrier, MageNoir, Magicien, Nain, OmbreNoir, Orque
}
