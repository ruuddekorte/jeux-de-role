...

{
	...
	private $name="";
	private $type="gobelin";  
	private $side="monstre" ;     // côté :heros ou monstres
	private $forceMin=50 ;        // attaque-Min=imum
	private $forceMax=200 ;       // attaque-maximum
	private $health=250;          // points de vie
	private $specialty="guerier"  // Spécialité : Elfe, Gobelin, Guerrier, MageNoir, Magicien, Nain, OmbreNoir, Orque
