...

{
	...
	private $name="";
	private $type="nain";      // Elfe, Gobelin, Guerrier, MageNoir, Magicien, Nain, OmbreNoir, Orque, Sauron
	private $side="hero" ;     // côté :heros ou monstres
	private $forceMin=100 ;     // attaque-Min=imum
	private $forceMax=150 ;     // attaque-maximum
	private $health=450;          // points de vie
	private $specialty="gobelin" // Spécialité : Elfe, Gobelin, Guerrier, MageNoir, Magicien, Nain, OmbreNoir, Orque
}
