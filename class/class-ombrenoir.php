...

{
	...
	private $name="";
	private $type="ombrenoir"; 
	private $side="monstre" ;     // côté :heros ou monstres
	private $forceMin=150 ;     // attaque-Min=imum
	private $forceMax=250 ;     // attaque-maximum
	private $health=350;          // points de vie
	private $specialty="elfe" // Spécialité : Elfe, Gobelin, Guerrier, MageNoir, Magicien, Nain, OmbreNoir, Orque
