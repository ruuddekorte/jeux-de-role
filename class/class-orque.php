...

{
	...
	private $name="";
	private $type="orque";      // Elfe, Gobelin, Guerrier, MageNoir, Magicien, Nain, OmbreNoir, Orque, Sauron
	private $side="monstre" ;     // côté :heros ou monstres
	private $forceMin=200 ;     // attaque-Min=imum
	private $forceMax=200 ;     // attaque-maximum
	private $health=400;          // points de vie
	private $specialty="nain" // Spécialité : Elfe, Gobelin, Guerrier, MageNoir, Magicien, Nain, OmbreNoir, Orque
