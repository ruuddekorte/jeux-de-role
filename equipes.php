    ...
    <div class="col-lg-1 col-sm-0"> &nbsp; </div>
            <div class="col-lg-5 col-sm-12">  
                <div class="input-group">
                  <div class="row"> 
                 		...
                 		<div class="col-sm-12 col-lg-7">Nom* :<br /><input id="hero1" type="text" class="form-control" /></div>
                 		...
                 		<div class="col-sm-12 col-lg-7">Nom* :<br /><input id="hero2" type="text"  class="form-control" /></div>
                 		...
                 		<div class="col-sm-12 col-lg-7">Nom* :<br /><input id="hero3" type="text"  class="form-control" /></div>
          ...
          <div class="col-lg-5 col-sm-12">  
            <div class="row"> 
                ...
                <div class="col-sm-12 col-lg-12">Personnage 1 :</div>
                <div class="col-sm-12 col-lg-7">Nom* :<br /><input id="monstre1" type="text"  class="form-control" /></div>
...
The pull-right command was removed and replaced with float-right or in general to float-{sm,md,lg,xl}-{left,right,none}
 -->
                <div class="col-lg-12 right"> <a href="combat.php"><button type="button" class="btn btn-secondary btn-lg float-lg-right float-sm-right start">[ Commencer ]</button></a>
                </div> 
                <div class="col-lg-12"> &nbsp; </div> 
              </div>
          </div>
